...
;(function (factory) {
    ...
    var ClipCarousel = function () {
        function ClipCarousel(element, options) {
    ...
    $.fn.clipCarousel = function () {
        var $this = this,
            ...
            ret = void 0;
        for (i = 0; i < length; i++) {
            if ((typeof opt === 'undefined' ? 'undefined' : _typeof(opt)) == 'object' || typeof opt == 'undefined') $this[i].clip_carousel = new ClipCarousel($this[i], opt);else ret = $this[i].clip_carousel[opt].apply($this[i].clip_carousel, args);
...
$('.photo-slider').clipCarousel({
    thumbs_selector: '.photo-slider-thumb'
});

$('#slide-next').on('click', function () {
    $('.photo-slider').clipCarousel('go_to', 'forward');
});

$('#slide-prev').on('click', function () {
    $('.photo-slider').clipCarousel('go_to', 'backward');
});